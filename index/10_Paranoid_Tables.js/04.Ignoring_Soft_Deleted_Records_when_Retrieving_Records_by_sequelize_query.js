...
.then(() => {
    ...
    return sequelize.query(
        'SELECT * FROM customer WHERE user_id = 4 LIMIT 1'
    )   
    //  You can still select the data after you soft delete
    //     Executing (default): SELECT * FROM customer WHERE user_id = 4 LIMIT 1
    // [
    //   [
    //     {
    //       user_id: 4,
