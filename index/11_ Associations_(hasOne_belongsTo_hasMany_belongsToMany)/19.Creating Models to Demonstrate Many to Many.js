...
// Executing (default): ALTER TABLE `customerproduct` CHANGE `createdAt` `createdAt` DATETIME NOT NULL;
// Executing (default): ALTER TABLE `customerproduct` CHANGE `updatedAt` `updatedAt` DATETIME NOT NULL;
// Executing (default): SHOW INDEX FROM `customerproduct`
